...
export default async function Page({params}: {params: any}) {
    ...
    <div className="">
        ...
        <div className="flex flex-col items-center border-b border-white px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          ...
          <h2>Antall ganger purret: {contract.purre_counter}</h2>
          <DownloadPdf />
          {contract.orgnr.length == 9 ? (
    ...
    <div className="bg-black px-6  py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-200">
        <div className="mb-8 ">
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl">Bedrift: {contract.buyer}</h1> <p className="text-md">OrgNr.{contract.orgnr}</p>
