...
import { sendContract } from '@/app/actions'
...
export default function Form({ users, produkter, countries }: { users: Users[], produkter: Produkter[], countries: Countries[] }) {
    ...
    const groupedProducts = items.reduce((acc, product) => {
     ...
     const categoryOrder = ['Nettside', 'Pakkeløsning', 'Annonsering', 'Film og foto', 'Organisk annonsering', 'Rådgiving', 'Annet', 'Visittkort'];
              ...
              return (
                <div key={produkt.id} className="mb-4 pb-4 border-b border-gray-700">
                  <div className="flex items-center">
                    ...
                    >
                      {produkt.name} <p className='text-red-500'>IKKE TILGJENGELIG</p>
                    </label>
                  </div>
