...
const GodkjeningFrom: React.FC<Readonly<ContractFormInputs>> = ({input, email, contact, seller, buyer, orgnr, address, phone, total, comment, user_email, user_phone}) => {
    const monthPrice = total / 12;
    const intMonthPrice = Math.round(monthPrice);
  return <div>
      <h1>Kontrakten fra Herman kristiansen har blitt signert</h1>
